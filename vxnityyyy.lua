...
ReactTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({ Title = "Optimización del Balón Activada", Desc = "Interpolación 0 y velocidad máxima", Icon = "zap" })
    end
})
        ReactTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({ Title = "Ultra Velocity Activado", Desc = "Delay negativo y velocidad cuántica", Icon = "zap" })
    end
})
